...
POOL_CREATED_PATH = "./sushiswap_v3_poolcreated_events/"
V3_POOL_FILE = "arbitrum_lps_sushiswapv3.json"
...
poolcreated_events: pyarrow.lib.Table = pyarrow.parquet.read_table(
